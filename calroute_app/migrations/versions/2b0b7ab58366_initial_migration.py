...
Revision ID: 2b0b7ab58366
Revises: 
Create Date: 2025-04-19 18:29:40.910046
...
def upgrade():
    ...
    sa.Column('travel_mode', sa.Enum('driving', 'walking', 'transit', name='travel_mode'), nullable=True),
    sa.ForeignKeyConstraint(['user_id'], ['users.user_id'], ondelete='CASCADE'),
